...
idx_to_atomidx = {0: 6, 1: 7, 2: 8, 3: 16, 4: 5, 5: 35, 6: 17, 7: 15, 8: 53, 9: 9}

# the last column/row is hydrogen
                #   C     N    O     S     B     Br    Cl    P     I     F     H
prot_mol_lj_rm = [[3.4 , 3.3 , 3.25, 3.5 , 3.5 , 3.6 , 3.5 , 3.65, 3.8 , 3.2 , 2.9 ],
                 [3.3 , 3.2 , 3.15, 3.4 , 3.4 , 3.5 , 3.4 , 3.55, 3.7 , 3.1 , 2.8 ],
                 [3.25, 3.15, 3.1 , 3.35, 3.35, 3.45, 3.35, 3.5 , 3.65, 3.05, 2.75],
                 [3.5 , 3.4 , 3.35, 3.6 , 3.6 , 3.7 , 3.6 , 3.75, 3.9 , 3.3 , 3.  ],
                 [3.5 , 3.4 , 3.35, 3.6 , 3.6 , 3.7 , 3.6 , 3.75, 3.9 , 3.3 , 3.  ],
                 [3.6 , 3.5 , 3.45, 3.7 , 3.7 , 3.8 , 3.7 , 3.85, 4.  , 3.4 , 3.1 ],
                 [3.5 , 3.4 , 3.35, 3.6 , 3.6 , 3.7 , 3.6 , 3.75, 3.9 , 3.3 , 3.  ],
                 [3.65, 3.55, 3.5 , 3.75, 3.75, 3.85, 3.75, 3.9 , 4.05, 3.45, 3.15],
                 [3.8 , 3.7 , 3.65, 3.9 , 3.9 , 4.  , 3.9 , 4.05, 4.2 , 3.6 , 3.3 ],
                 [3.2 , 3.1 , 3.05, 3.3 , 3.3 , 3.4 , 3.3 , 3.45, 3.6 , 3.  , 2.7 ],
                 [2.9 , 2.8 , 2.75, 3.  , 3.  , 3.1 , 3.  , 3.15, 3.3 , 2.7 , 2.4 ]]
